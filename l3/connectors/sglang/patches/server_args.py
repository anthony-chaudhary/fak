...
class ServerArgs:
    ...
    def _handle_hicache(self):
        ...
        if self.hicache_storage_backend == "cama":
            from sglang.srt.mem_cache.storage.cama.preflight import (
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=str,
            choices=["file", "mooncake", "hf3fs", "nixl", "aibrix", "dynamic", "eic", "cama"],
            default=ServerArgs.hicache_storage_backend,
            help="The storage backend for hierarchical KV cache. "
            "Built-in backends: file, mooncake, hf3fs, nixl, aibrix, cama. "
