...
class SchedulerMetricsMixin:
    ...
    def log_prefill_stats(
        ...
        if self.enable_metrics:
            ...
            if hasattr(self, 'tree_cache') and hasattr(self.tree_cache, 'cache_controller'):
                try:
                    self.tree_cache.cache_controller.push_scheduler_metrics({
                        "cache_hit_rate": cache_hit_rate,
                        "token_usage": token_usage,
                        "num_running_reqs": running_bs,
                    })
                except Exception:
                    pass
