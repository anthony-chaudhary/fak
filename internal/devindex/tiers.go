...
var verbTiers = map[string]VerbTier{
	...
	"cadence":                       TierDev,
	"callavoid":                     TierDev,
	"causal-receipt":                TierDev,
	"causalreceipt":                 TierDev,
	"chat":                          TierDev,
	"chatops":                       TierDev,
	"chatrelay":                     TierDev,
	...
	"clean-bins":                    TierDev,
	"cloud-handoff":                 TierDev,
	"cloudhandoff":                  TierDev,
	"cluster":                       TierDev,
	"codelint":                      TierDev,
	"code-debt":                     TierDev,
	"codebookmeta":                  TierDev,
	...
	"cron":                          TierDev,
	"ctxplans":                      TierDev,
	"cubicquanteval":                TierDev,
	"cuda-gpudirect":                TierDev,
	"debug":                         TierDev,
	"debt-lanes":                    TierDev,
	...
	"issue-lanes":                   TierDev,
	"issue-orchestrator":            TierDev,
	"issue-queue":                   TierDev,
	"issue-stats":                   TierDev,
	"issues-recent":                 TierDev,
	"issues-solved":                 TierDev,
	"knownbad":                      TierDev,
	"kvbm":                          TierDev,
	"l3-serve":                      TierDev,
	"l3serve":                       TierDev,
	...
	"agentx":                        TierDev,
	"amd-strix-package":             TierDev,
	"amd-strix-probe":               TierDev,
	"amd-strix-validate":            TierDev,
	"amdgpu":                        TierDev,
	"build-cuda":                    TierDev,
	"build-vulkan":                  TierDev,
	"client":                        TierDev,
	"containment":                   TierDev,
	"conversation-profile":          TierDev,
	"cuda-build":                    TierDev,
	"debt-orchestrator":             TierDev,
	"factory-migrate":               TierDev,
	"factorymigrate":                TierDev,
	"goal-fleet":                    TierDev,
	"goal-launch":                   TierDev,
	"harness-hint":                  TierDev,
	"harnesshint":                   TierDev,
	"managedocs":                    TierDev,
	"observer":                      TierDev,
	"readme":                        TierDev,
	...
	"roofline":                      TierDev,
	"sensecheck":                    TierDev,
	"sessionsearch":                 TierDev,
	"strix":                         TierDev,
	"strix-probe":                   TierDev,
	"strix-validate":                TierDev,
	"sweep-speculative":             TierDev,
	"vulkan-build":                  TierDev,
}
