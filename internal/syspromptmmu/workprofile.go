...
func WorkProfileNames() []string {
	return []string{WorkProfileStandard, "off", "ponytail:low", "ponytail:medium", "ponytail:high", WorkProfilePonytailNativeLow, WorkProfilePonytailNativeMed, WorkProfilePonytailNativeHigh}
}
...
func DescribeWorkProfile(name string) WorkProfileReadout {
	...
	if strings.HasPrefix(raw, "ponytail:") && strings.Count(raw, ":") == 1 {
