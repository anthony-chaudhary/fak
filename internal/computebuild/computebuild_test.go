...
func TestVulkanShadersCompleteness(t *testing.T) {
	if len(VulkanShaders) != 47 {
		t.Fatalf("expected 47 Vulkan shaders, got %d", len(VulkanShaders))
	}
	...
	expectedShaders := []string{
		...
		"swiglu_q8_matmul_add", "qwen35_gdn_q8_in_proj", "qwen35_gdn_q8_panel", "qwen35_gdn_conv", "qwen35_gdn_recurrent",
