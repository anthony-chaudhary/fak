...
func TestDiskDeviceSpellingsAreByteIdenticalToTheShippedPolicy(t *testing.T) {
	...
	want := map[string]map[string]bool{
		defaultDeviceOpDenyRegex: {"bash": false, "shell_command": false, "functions.shell_command": false},
		defaultPSDiskOpDenyRegex: {"powershell": false, "shell_command": false, "functions.shell_command": false},
	}
