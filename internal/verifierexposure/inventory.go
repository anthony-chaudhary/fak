...
func DeclaredInventory() []Gate {
	return []Gate{
		...
		{Name: "policy-hermes-judge", Kind: LLMJudge, Sources: []string{"internal/ctxmmu/hermes_resultside_bench_test.go"}, SignalProbes: []SignalProbe{{Path: "internal/ctxmmu/hermes_resultside_bench_test.go", Contains: "_smart_approve"}}, FailsOpen: true, InjectableProse: true},
