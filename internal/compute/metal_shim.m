...
static const char *kShaderSrc =
    ...
    "}\n"
    "\n"
    "inline void attention_f32_impl(device const float* q,\n"
    ...
    "                               threadgroup float* qs, threadgroup float* tg_sums) {\n"
    "    if ((int)h >= nH) return;\n"
    "    int grp = nH / nKV;\n"
    "    int kvh = (int)h / grp;\n"
    "    int w = nKV * hd;\n"
    ...
    "    attention_f32_impl(q, K, V, outp, nPos, nH, nKV, hd, scale, h, tid, tg_size, qs, tg_sums);\n"
    "}\n"
    "\n"
