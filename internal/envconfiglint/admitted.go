...
var admittedPostFreeze = []string{
	...
	// Grandfathered post-freeze reads across recent trunk advances (#11990, #11992)
	"ALLOW_CACHE_HEADLINE_DRIFT",
	"ALLOW_SILENT_MERGE",
	"AR",
	"CLAUDE_PROJECT_DIR",
	"CODEX_EXPERIMENTAL_COMPACT_PROMPT_FILE",
	"COMSPEC",
	"CUDA_HOME",
	"CUDA_PATH",
	"CXX",
	...
	"FAK_AGENT_POSTURE",
	"FAK_ALLOWED_DB_HOSTS",
	"FAK_CHILD_RESOURCE_USAGE_PATH",
	"FAK_CODEX_BASE_URL",
	"FAK_CTXMMU_PERMISSIVE",
	"FAK_CTXRESTORE_CAS_DIR",
	"FAK_DIRECT_SLAB",
	"FAK_DISABLE_VECTOR_GDN",
	"FAK_GATEWAY_URL",
	"FAK_GUARD_CRASH_RSI_MODEL",
	"FAK_GUARD_CRASH_RSI_PROVIDER",
	"FAK_GUARD_HEADROOM_DEBOUNCE",
	"FAK_GUARD_POSTURE",
	"FAK_GUARD_REASONING_EFFORT",
	"FAK_GUARD_REASONING_POSTURE",
	"FAK_IFC_MODE",
	"FAK_IFC_PERMISSIVE",
	...
	"FAK_MCP_CONFIG",
	"FAK_MOCK_GFX1151",
	"FAK_MODEL_CAPABILITIES",
	"FAK_NGRAM_AVX512",
	"FAK_NUMA_REPLICAS",
	"FAK_OBJECTIVE",
	"FAK_ORCHESTRATION_WORKER_EFFORT",
	"FAK_ORCHESTRATION_WORKER_MODEL",
	"FAK_PRIVATE_ROOT",
	"FAK_PROFILE",
	"FAK_REMOTE_KV_BACKEND",
	"FAK_REMOTE_KV_MODE",
	"FAK_REMOTE_KV_TIMEOUT",
	"FAK_REMOTE_KV_URL",
	"FAK_RESPONSES_ELIDE_THRESHOLD",
	"FAK_RESPONSES_MAX_SUBTURN_TOKENS",
	"FAK_RESPONSES_MAX_SUBTURN_TOOL_CALLS",
	"FAK_RESPONSES_SUBTURN_TOOL_CALL_THRESHOLD",
	"FAK_RESPONSES_SUBTURN_YIELD",
	"FAK_ROOFLINE_FORCE_SIM",
	"FAK_ROOFLINE_SIM",
	"FAK_ROOT",
	"FAK_SANDBOX_TIER",
	"FAK_SELF_UPDATE_VERBOSE",
	"FAK_STRIX_DIR",
	"FAK_STRIX_HOST",
	"FAK_STUDY_REGISTRY",
	"FAK_TEST_STARTUP_PEAK_BYTES",
	"FAK_TEST_STEADY_BYTES",
	...
	"FAK_WORKSPACE",
	"FAK_WORKSPACE_ROOT",
	"FLEET_ALLOW_SILENT_MERGE",
	"FLEET_BUILDCHECK_GUARD",
	"GEMINI_CLI_HOME",
	"GEMINI_CONFIG_DIR",
	"GEMINI_HOME",
	"GEMINI_TMP_DIR",
