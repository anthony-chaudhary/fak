...
//	TierFrontier (1)  the max-quality frontier set (Opus-class, GPT-5.5, DeepSeek
//	                  V4 Pro, Kimi K2.6) — the default target for a hard task.
//	TierLight    (2)  the lightweight-work set (GLM-5.2, Gemini 3.5 Flash).
