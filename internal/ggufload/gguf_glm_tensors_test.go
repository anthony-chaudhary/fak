...
func TestGLMMoeDsaCanonicalTensorNames(t *testing.T) {
	...
	glm := map[string]string{
		...
		"blk.3.indexer.attn_q_b.weight": "model.layers.3.self_attn.indexer.wq_b.weight",
		"blk.3.indexer.attn_k.weight":   "model.layers.3.self_attn.indexer.wk.weight",
		"blk.3.indexer.k_norm.weight":   "model.layers.3.self_attn.indexer.k_norm.weight",
		"blk.3.indexer.k_norm.bias":     "model.layers.3.self_attn.indexer.k_norm.bias",
		"blk.3.indexer.proj.weight":     "model.layers.3.self_attn.indexer.weights_proj.weight",
	}
