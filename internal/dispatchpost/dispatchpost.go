...
// every workspace. (scoreboard.envFileValue is unexported, so the six-line walk-up is
// repeated here rather than exported — it is file I/O, not logic worth coupling.)
