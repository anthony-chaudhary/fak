...
func hedgeRouter(primary, alternate agent.Planner, policy *HedgePolicy) *ReplicaDispatch {
	r, err := NewReplicaDispatch("same", []PlannerReplica{{Name: "primary", Planner: primary}, {Name: "alternate", Planner: alternate}})
	if err != nil {
		panic(err)
	}
	r.Hedge = policy
...
func TestReplicaDispatchHedgeFirstValidAndCancellationReceipt(t *testing.T) {
...
func TestReplicaDispatchHedgeRejectsMalformedFirst(t *testing.T) {
...
func TestReplicaDispatchHedgeAppliesAcceptedOutputValidator(t *testing.T) {
...
func TestReplicaDispatchHedgePrimaryBeforeDelayStaysSingleDispatch(t *testing.T) {
...
func TestReplicaDispatchHedgeIneligibleCallsStaySingleDispatch(t *testing.T) {
	cases := []struct {
		name   string
...
func TestReplicaDispatchHedgeBoundedDrainDoesNotHoldWinner(t *testing.T) {
...
func TestReplicaDispatchHedgeBothInvalidReturnsTypedJoinedError(t *testing.T) {
