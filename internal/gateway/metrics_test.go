...
func TestHTTPMetricsEndpointExposesGatewayAndKernelCounters(t *testing.T) {
	...
	for _, want := range []string{
		...
		`fak_gateway_operations_total{operation="syscall",verdict="ALLOW",reason="",disposition=""} 1`,
		`fak_gateway_operation_duration_seconds_count{operation="syscall",verdict="ALLOW",reason="",disposition=""} 1`,
