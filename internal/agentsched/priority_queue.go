...
// PriorityQueue implements a multi-level priority queue with four priority tiers (P0..P3)
// and a fixed capacity ceiling.
...
// When the queue reaches capacity, Enqueue returns abi.ErrQueueFull without blocking.
