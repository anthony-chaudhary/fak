...
// over the three cadence dimensions an operator tracks: scores, work-done, and
// releases.
//
...
//
// Nothing folds those three into ONE "where do we stand this week?" envelope, and
...
// sub-tool payload), Fold (fold the three dimensions into one envelope),
// ParseLedger / TrendVsLast (the durable history + per-tick trend), and
