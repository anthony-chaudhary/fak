...
func (m *ShardMetrics) IncrEvictionsKeyPressure()   { m.evictionsKeyPressure.Add(1); m.lifetimeEvictionsKeyPressure.Add(1) }
func (m *ShardMetrics) IncrEvictionsValuePressure() { m.evictionsValuePressure.Add(1); m.lifetimeEvictionsValuePressure.Add(1) }
func (m *ShardMetrics) IncrEvictionsFailed()        { m.evictionsFailed.Add(1); m.lifetimeEvictionsFailed.Add(1) }
func (m *ShardMetrics) IncrEvictionsLeaseSkip()     { m.evictionsLeaseSkip.Add(1); m.lifetimeEvictionsLeaseSkip.Add(1) }
func (m *ShardMetrics) IncrEvictionsRebalance()     { m.evictionsRebalance.Add(1); m.lifetimeEvictionsRebalance.Add(1) }
...
func (m *ShardMetrics) AddRDMAReadBytesOut(n int64)  { m.rdmaReadBytesOut.Add(n); m.lifetimeRDMAReadBytesOut.Add(n) }
...
func (m *ShardMetrics) LifetimeEvictionsKeyPressure() int64   { return m.lifetimeEvictionsKeyPressure.Load() }
func (m *ShardMetrics) LifetimeEvictionsValuePressure() int64 { return m.lifetimeEvictionsValuePressure.Load() }
