...
// answer from the kernel's own process table, never from a self-report. Same
// oracle as internal/toolprocgate (issue #2357), copied per-package because the
// helpers are test-scoped.
//
