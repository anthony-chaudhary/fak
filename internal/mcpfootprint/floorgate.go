...
// docs/context-budget/mcp-tool-floor.md (24 tools · 5460 est. tokens · 21843 bytes).
//
...
// it whenever a deferral banks a win.
const FloorBudgetTokens = 5460
...
// banked into the constant. ~4.6% of the current floor.
