...
- host STREAM context for AMD Halo and DGX Spark;
...
- DGX Spark list/street observations when NVIDIA Marketplace itself timed out.
...
- **128 GB Apple:** 20–32 GiB because the configuration was not shipping and no M5 pressure trace
  existed.
- **128 GB DGX Spark:** 16–24 GiB for DGX OS, CUDA/runtime state, services, and workspaces.
...
3. No shipping M5 Max 128 GB memory-pressure, bandwidth, power, or street-price evidence as of
   2026-08-27.
4. No GPU-counter sustainable bandwidth result for DGX Spark; host STREAM is not a substitute.
