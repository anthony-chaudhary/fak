...
- [`docs/notes/GPU-SERVER-OVERNIGHT-PLAN-2026-06-28.md`](GPU-SERVER-OVERNIGHT-PLAN-2026-06-28.md) — the honest frontier-MoE wall.
...
([GPU-SERVER-OVERNIGHT-PLAN](GPU-SERVER-OVERNIGHT-PLAN-2026-06-28.md)). The fix is
...
- **The safety rail that makes it overnight-safe:** the load-time **capacity
  ...
  [GPU-SERVER-OVERNIGHT-PLAN](GPU-SERVER-OVERNIGHT-PLAN-2026-06-28.md)).
