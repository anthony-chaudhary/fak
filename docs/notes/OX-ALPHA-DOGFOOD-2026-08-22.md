...
- **Close: #8591.** The search has six `TODO(#5331)` hits rather than four, and parent #5331 is already closed as shipped. Introducing a production anchor merely to single-source TODO prose would preserve stale work rather than resolve it.
