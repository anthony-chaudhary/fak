...
[cache frontier operating plan](../cache-frontier/README.md). It records what the current tree proves
today, without promoting thin evidence into a bigger claim. The matching machine row is
in [`review-ledger.jsonl`](../cache-frontier/review-ledger.jsonl) under schema
