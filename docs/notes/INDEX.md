# Selected source studies

This local index links the studies listed here; it is not a complete inventory of dated notes. The [repository index](../../INDEX.md) and [documentation map](../index.md) remain the broader navigation surfaces. See [notes lifecycle](README.md) for how to interpret historical evidence.
