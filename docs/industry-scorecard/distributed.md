...
- **SOTA bar:** GB300 NVL72 (72 Blackwell-Ultra GPUs in one NVLink domain) set MLPerf Inference v5.1 records, delivering up to 40% more DeepSeek-R1 reasoning throughput than the prior generation; disaggregated serving via NVIDIA Dynamo added up to 1.5x on Llama-3.1-405B interactive.
- **Leading systems:** NVIDIA GB300 NVL72 + Dynamo (MLPerf v5.1), SGLang/TensorRT-LLM multi-node, GB200 NVL72 (prior generation)
- **Source:** [https://developer.nvidia.com/blog/nvidia-blackwell-ultra-sets-new-inference-records-in-mlperf-debut/](https://developer.nvidia.com/blog/nvidia-blackwell-ultra-sets-new-inference-records-in-mlperf-debut/) (2025-09)
- **fak:** no-claim — no number (stub)
