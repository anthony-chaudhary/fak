...
## Current-main recovery, 2026-09-12

The five preserved paths remain missing from main and apply cleanly. A separate recovery task retained the source worktree unchanged and acquired a scoped lease. Required isolated validation against `5b6a02396efa7d7f9d858e1c56d8c4a89b881660`, combined with disjoint guard recovery paths, passed formatting, build, and vet, then timed out during affected-package tests at 720013 ms. Smoke was not reached. The initial WSL preflight refusal cleared on the serialized retry; no gate was bypassed.

Recovery is preserved under local ref `refs/fak/wip/operational-recovery-12876-12877`, initial object `975aff966c53df150deec92a8d8ab9fbcb8b2a92`. Receipt: `_scratch/operational-recovery/public-validation-retry.json` in the recovery task. No commit or push is claimed. Keep #12877 open until the required affected-package test and smoke gate completes, then land only the five scoped lease-release paths.

A subsequent focused diagnostic against newer observed main `2634b9edb4fc319f6b363b6a9f206ff311dafe90` refused at WSL capability preflight (15219 ms) before tests. This is UNRUN, not a focused pass. No gate was bypassed.
