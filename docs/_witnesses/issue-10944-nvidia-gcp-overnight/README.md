...
| `gcp_h100_hopper_bench_raw.json` | `fak.gcp-vm-bench.v2` | `a43c1480e504d6cff8cfd9b718eb7cd10bd3ba9e6294509d3f8b9cf301cc3e18` | GCP A3 Hopper H100 physical benchmark run across llama, fak-cuda, fak-cuda-q8, fak-cuda-tf32 |
