...
fak kvbm      replay [--artifact FILE] [--json] [--check]   # KVBM eviction validation: cost-aware>=LRU, active-pin safety, and byte-stable restore over a committed replay artifact
