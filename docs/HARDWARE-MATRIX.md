...
**Grade A** - value 1 - legacy score 100 - support_maturity_debt **0** (sum(target-current) rungs over 0 cell(s) below their declared target) - 32/56 cells SUPPORTED
...
| Qwen2/3.x | PreNorm | SUPPORTED | SUPPORTED | SUPPORTED | SUPPORTED |
| GPT-NeoX | ParallelResidual | SUPPORTED | FENCED | FENCED | FENCED |
| Falcon | ParallelResidual | SUPPORTED | FENCED | FENCED | FENCED |
| MPT | PreNorm | SUPPORTED | SUPPORTED | SUPPORTED | SUPPORTED |
| StableLM | PreNorm | SUPPORTED | SUPPORTED | SUPPORTED | SUPPORTED |
| OLMo2 | PostNorm | SUPPORTED | FENCED | FENCED | FENCED |
| Cohere | ParallelResidual | SUPPORTED | FENCED | FENCED | FENCED |
| Gemma2/3 | SandwichNorm | SUPPORTED | FENCED | FENCED | FENCED |
| Mixtral-MoE | PreNorm | SUPPORTED | SUPPORTED | SUPPORTED | SUPPORTED |
| gpt-oss-MoE | PreNorm | SUPPORTED | SUPPORTED | SUPPORTED | SUPPORTED |
| DeepSeek-MLA | SparseAttn | SUPPORTED | FENCED | FENCED | FENCED |
| GLM-5.2-DSA | SparseAttn | SUPPORTED | FENCED | FENCED | FENCED |
| MiniMax-MSA | SparseAttn | SUPPORTED | FENCED | FENCED | FENCED |

Counts: 32 SUPPORTED, 0 PROOF-PATH-ONLY, 24 FENCED, 0 UNDEFINED across 56 cells (14 families x 4 backends).
...
- **Batched multi-user decode curve** — SmolLM2-135M Q8 peaks at **862 agg tok/s** at
  ...
  → [`docs/benchmarks/CROSS-MACHINE-INFRASTRUCTURE.md`](https://github.com/anthony-chaudhary/fak/blob/main/docs/benchmarks/CROSS-MACHINE-INFRASTRUCTURE.md)
