...
**Grade B** - value 0.821 - legacy score 82.1 - support_maturity_debt **10** (sum(target-current) rungs over 10 cell(s) below their declared target) - 22/56 cells SUPPORTED
...
Counts: 22 SUPPORTED, 10 PROOF-PATH-ONLY, 24 FENCED, 0 UNDEFINED across 56 cells (14 families x 4 backends).
