...
**Grade B** - value 0.875 - legacy score 87.5 - support_maturity_debt **7** (sum(target-current) rungs over 7 cell(s) below their declared target) - 25/56 cells SUPPORTED
...
Counts: 25 SUPPORTED, 7 PROOF-PATH-ONLY, 24 FENCED, 0 UNDEFINED across 56 cells (14 families x 4 backends).
