...
**Grade B** - value 0.804 - legacy score 80.4 - support_maturity_debt **11** (sum(target-current) rungs over 11 cell(s) below their declared target) - 21/56 cells SUPPORTED
...
Counts: 21 SUPPORTED, 11 PROOF-PATH-ONLY, 24 FENCED, 0 UNDEFINED across 56 cells (14 families x 4 backends).
