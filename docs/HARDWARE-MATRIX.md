...
**Grade B** - value 0.839 - legacy score 83.9 - support_maturity_debt **9** (sum(target-current) rungs over 9 cell(s) below their declared target) - 23/56 cells SUPPORTED
...
Counts: 23 SUPPORTED, 9 PROOF-PATH-ONLY, 24 FENCED, 0 UNDEFINED across 56 cells (14 families x 4 backends).
