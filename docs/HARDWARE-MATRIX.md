...
**Grade C** - value 0.768 - legacy score 76.8 - support_maturity_debt **13** (sum(target-current) rungs over 13 cell(s) below their declared target) - 19/56 cells SUPPORTED
