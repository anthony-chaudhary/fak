...
| Roadmap and TODOs | The inventory found no roadmap/TODO source class and GitHub milestones were empty. FAK does not infer a roadmap from incidental source comments or release cadence. |
