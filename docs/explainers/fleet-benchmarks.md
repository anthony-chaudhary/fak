...
[`docs/benchmarks/LEGACY-BENCH-INDEX.md`](https://github.com/anthony-chaudhary/fak/blob/main/docs/benchmarks/LEGACY-BENCH-INDEX.md).
...
- **[Benchmarking index](https://github.com/anthony-chaudhary/fak/blob/main/docs/benchmarks/LEGACY-BENCH-INDEX.md)** — how to read the baselines, the
