...
- **Scoreboard & portfolio debt:** [Scoreboard debt portfolio](scoreboard-debt.md) — unified unbounded summary of all 50 scorecard debt categories, dual-axis ratchets, and deterministic verification.
...
- [Scoreboard debt portfolio](scoreboard-debt.md) — comprehensive unbounded summary across all 50 scorecard debt categories folded into the portfolio control pane.
