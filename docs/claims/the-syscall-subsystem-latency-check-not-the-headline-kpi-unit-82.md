---
title: "fak syscall latency check: in-process versus spawned hook"
description: "The syscall regression check measures the same adjudication fold in process and through a spawned hook; it is not a serving or model-performance headline."
---
