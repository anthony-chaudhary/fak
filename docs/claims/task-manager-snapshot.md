---
title: "fak task manager snapshot: process resources and ETA"
description: "fak task sample reports process-local task and step resource deltas plus ETA when progress is known; it is not a durable or cross-process scheduler."
---
