...
| BEHIND | refusal | floor-absent | no enforcing floor declared — vocabulary-only |
...
| DEFAULT_DENY | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| DISAMBIGUATION_TIMEOUT | refusal | floor-absent | no enforcing floor declared — bounded timeout refusal vocabulary |
| DIVERGED | refusal | floor-absent | no enforcing floor declared — vocabulary-only |
...
| EGRESS_BLOCK | refusal | floor-declared | `Floor:` cite in the dos.toml block |
...
| LEASE_HELD | refusal | floor-declared | `Floor:` cite in the dos.toml block |
...
| MALFORMED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| MEMORY_NEAR_DUPLICATE | advisory | floor-declared | `Floor:` cite in the dos.toml block |
...
| MISROUTE | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| MODEL_TOON_UNFIT | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| MODULE_REV_STALE | refusal | floor-absent | no enforcing floor declared — vocabulary-only |
...
| OVERSIZE | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| PAYLOAD_TOO_SMALL | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| PII_EXFIL | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| PII_REDACTED | advisory | floor-declared | `Floor:` cite in the dos.toml block |
| PIN_EVICT_REFUSED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| POLICY_BLOCK | refusal | floor-declared | `Floor:` cite in the dos.toml block |
...
| RATE_LIMITED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
...
| RESULT_SECRET_DISCOVERED | advisory | floor-declared | `Floor:` cite in the dos.toml block |
...
| SECRET_EXFIL | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| SECRET_REDACTED | advisory | floor-declared | `Floor:` cite in the dos.toml block |
| SESSION_CEILING_SATURATED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| SHELL_DIALECT | advisory | floor-declared | `Floor:` cite in the dos.toml block |
...
| TEST_TAMPER_REFUSED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
...
| TIER_DECLARED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| TRUST_VIOLATION | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| UNAUTHENTICATED_OFF_HOST_BIND | refusal | floor-absent | no enforcing floor declared — vocabulary-only |
| UNKNOWN_TOOL | refusal | floor-declared | `Floor:` cite in the dos.toml block |
| UNTIERED_LEAF | refusal | floor-absent | no enforcing floor declared — vocabulary-only |
| UNWITNESSED | refusal | floor-declared | `Floor:` cite in the dos.toml block |
