...
# Bench-DX scorecard 20260625T235057Z
...
| `catalog_registry` | discover | [x] | internal/benchcatalog/catalog.go registry present (25 entries) |
| `registry_covers_tree` | discover | [x] | registry covers all 25 surfaces one-to-one |
| `offline_set` | coldstart | [x] | registry marks the offline set (17 zero-asset benchmarks) |
...
| `summary_self_describes` | read | [x] | all 25 registry rows carry a one-line 'what this number means' |
