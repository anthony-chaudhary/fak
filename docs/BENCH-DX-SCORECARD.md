...
# Bench-DX scorecard 20260627T002115Z
...
| `catalog_registry` | discover | [x] | internal/benchcatalog/catalog.go registry present (43 entries) |
| `registry_covers_tree` | discover | [x] | registry covers all 43 surfaces one-to-one |
| `offline_set` | coldstart | [x] | registry marks the offline set (33 zero-asset benchmarks) |
...
| `summary_self_describes` | read | [x] | all 43 registry rows carry a one-line 'what this number means' |
