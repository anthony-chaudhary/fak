...
No official public `DeepSeek-V4.1-Flash` weights, configuration, tokenizer, reference implementation, or license have been verified. Until DeepSeek publishes such an artifact, `fak` compatibility must be named for the pinned V4 Flash 0731 checkpoint rather than V4.1.
