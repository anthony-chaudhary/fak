...
**Slop-debt (total HARD defects): 192** — the primary, unbounded metric. Drive it to 0; every retired clone/dead symbol/vacuous test moves it. (The /100 score below saturates at zero defects and is NOT the driver.)

| Metric | Value |
|---|---|
| **Slop-debt (total HARD defects)** | **192** |
| Legacy bounded score (saturates; not the driver) | -7.7/100 (grade F) |
| Soft signals (advisory) | 2100 |

## Per-KPI (worst-first)

| KPI | Score | Slop-debt | Detail |
|---|---:|---:|---|
| duplication | -262/100 | 181 | 181 duplicated block(s): 24 extractable · 81 local · 76 pair (payoff-weighted debt 102.5) |
| dead_code | 70/100 | 6 | 6 dead unexported symbol(s) |
| vacuous_tests | 50/100 | 5 | 5 vacuous of 30232 Test func(s) |
...
> 192 unit(s) of slop-debt; score -7.7/100 (grade F); heaviest KPI: duplication (181 defect(s))
