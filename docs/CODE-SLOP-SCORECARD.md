...
<!-- code-slop-scorecard: 2026-07-18 · process: tools/code_slop_scorecard.py -->
...
**Slop-debt (total HARD defects): 467** — the primary, unbounded metric. Drive it to 0; every retired clone/dead symbol/vacuous test moves it. (The /100 score below saturates at zero defects and is NOT the driver.)

| Metric | Value |
|---|---|
| **Slop-debt (total HARD defects)** | **467** |
| Legacy bounded score (saturates; not the driver) | -148.9/100 (grade F) |
| Soft signals (advisory) | 1308 |

## Per-KPI (worst-first)

| KPI | Score | Slop-debt | Detail |
|---|---:|---:|---|
| duplication | -814/100 | 457 | 457 duplicated block(s): 107 extractable · 153 local · 197 pair (payoff-weighted debt 282.0) |
| dead_code | 55/100 | 9 | 9 dead unexported symbol(s) |
| vacuous_tests | 90/100 | 1 | 1 vacuous of 19316 Test func(s) |
...
| zero-FP soak (releases since 0.34.0) | 7/3 |
| promotable now | yes |
...
> 467 unit(s) of slop-debt; score -148.9/100 (grade F); heaviest KPI: duplication (457 defect(s))
