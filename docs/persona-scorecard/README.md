...
| Hard affordances present | 62 / 62 |
...
|---|---|---|---|---|---|
| ★ | served | build | deep | 8/8 | **Open-source contributor** — Add a feature as a leaf and ship it green, knowing the enforced rules up front so the guard teaches instead of ambushes. |
...
| reality | `affordances_present` | 100 | 0 | 62/62 hard affordances present (100%) |
