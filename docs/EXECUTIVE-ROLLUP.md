...
the locally generated `docs/dispatch-status.md` report (gitignored, so it is not published),
the [GLM-5.2 cache-value packet](benchmarks/GLM52-FAK-KERNEL-CACHE-VALUE-RESULTS.md),
