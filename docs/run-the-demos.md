...
|---|---|---|
| **Security and policy** | default-deny behavior, tool poisoning, safe escalation, policy reloads, or red-team corpora | `guarddemo`, `poisonedmcpdemo`, `examples/adjudication-demo`, `examples/agentdojo-redteam`, `examples/wire-proof`, `examples/wire-quarantine-demo`, `examples/auth-hardening`, `examples/escalation-demo`, `examples/policy-hot-reload`, `examples/trace-reset`, `examples/presets`, `examples/observability`, `examples/macos-guard-child-memory-demo` |
