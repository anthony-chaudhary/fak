...
| [`nlpodyssey/spago@3130dda`](https://github.com/nlpodyssey/spago/tree/3130dda657565c0b6b8e494070d8c35a037eee4e) | Native Go engine | Self-contained Go/assembly CPU tensor, autograd and neural layers. | Mature custom ML/NLP substrate, but paused and without turnkey current LLM formats. BSD-2-Clause plus assembly provenance. |
