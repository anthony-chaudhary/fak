...
| **CURRENT** | `q38-q4km-native-metal-m3pro-fullrun` | Matched full-run decode **6.8633 tok/s**, full prefill **76.19 tok/s** (P32/T64, temperature 0, 3 repetitions). | `PASS`: exact greedy token equality across all 64 positions and logit parity (max abs diff 0.0001 ≤ 0.001 tolerance) with **0 fallbacks**; throughput ratio **0.9852** vs pinned llama.cpp b9828 (6.9667 tok/s) ≥ 0.95 threshold. Engine `fak-native`, backend `metal`, forward path `metal/qwen35-hybrid-session-v1`, `fallback_active=false`. | [#9513 M10 parity receipt](../_witnesses/issue-9513-qwen38-m10-parity/README.md); artifact `unsloth/Qwen3.8-27B-GGUF@f1bfb127c64f7072bdd2cad55f258b9c8b2910fe` SHA-256 `7e78da5d7e3ae28d178121f58646953305f3e5bd3cb46f4a75584e8b6c6fe169`; Apple M3 Pro, 18 GPU cores, 36 GiB, darwin/arm64; observed **2026-09-03**; review by **2026-09-17**. Superseded 2026-08-20 full-run range **2.3–2.9 tok/s** remains in the [Metal detail](QWEN38-27B-LATEST.md). |
...
| **AWAITING REMEASURE** | M3 Pro Qwen3.8-27B four-way MTP comparison fixture ([#12239](https://github.com/anthony-chaudhary/fak/issues/12239)) | The published **[SIMULATED] 15.22 / 14.85 / 14.98 / 12.14 tok/s** values and acceptance rates are deterministic validator fixtures, not physical measurements. No raw four-arm packet or bound evidence files are committed; see the [simulated MTP detail](../claims/qwen38-native-mtp-speculative-decode.md). The accepted [#9525 sequence-prefill receipt](../_witnesses/issue-9525-qwen38-sequence-prefill/README.md) remains a separate current component result. | Promote only after all four engines run on the same physical Mac, artifact, prompt set, and controls, with immutable raw and quality receipts; review by **2026-09-22**. |
