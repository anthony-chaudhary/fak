...
| Indexed literal code search with exact line verification | `internal/trigram` | native; linear scan; ripgrep; git grep; Zoekt; livegrep; Sourcegraph Search | [local contract](INDEXED-CODE-SEARCH-ALTERNATIVES-2026-08-10.md), external witnesses [#6184](https://github.com/anthony-chaudhary/fak/issues/6184) | INCOMPLETE |
| Standalone Go syntax validation with all-error locations | `internal/codelint` | native; go/parser first-error; go test; gofmt; go vet; staticcheck; golangci-lint; gopls | [local contract](GO-SYNTAX-VALIDATION-ALTERNATIVES-2026-08-10.md), external witnesses [#6187](https://github.com/anthony-chaudhary/fak/issues/6187) | INCOMPLETE |
| Multi-provider token-usage class normalization and reconciliation | `internal/canon` | native; totals only; `fak + OpenAI`; `fak + Anthropic`; `fak + local`; `fak + OpenTelemetry`; provider SDKs; LiteLLM; OTel GenAI; LangSmith | [local contract](TOKEN-USAGE-NORMALIZATION-ALTERNATIVES-2026-08-10.md), integration/external witnesses [#6189](https://github.com/anthony-chaudhary/fak/issues/6189) | INCOMPLETE |
| Self-contained compiled ABI and adjudication conformance | `internal/conformance` | native; schema equality; OPA test; Conftest; JSON Schema/OpenAPI; Pact; Cedar | [local contract](COMPILED-CONFORMANCE-ALTERNATIVES-2026-08-10.md), external witnesses [#6191](https://github.com/anthony-chaudhary/fak/issues/6191) | INCOMPLETE |
