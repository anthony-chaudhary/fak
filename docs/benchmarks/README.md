...
| [MAC-THREEWAY-BENCH-2026-09-03.md](../notes/MAC-THREEWAY-BENCH-2026-09-03.md) | results | Empirical three-way comparison on Apple M3 Pro (Qwen3.8-27B Q4_K_M): fak-native vs llama.cpp vs MLX on Metal. | Decode parity achieved: fak-native 7.61 tok/s (+3.1% vs llama.cpp 7.38); prefill 48.54 vs 52.74 tok/s; RadixAttention shared-prefill TTFT flat at 12.60 ms (>190× speedup) |
