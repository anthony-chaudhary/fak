...
<!-- learning-scorecard: 2026-07-03 · process: tools/learning_scorecard.py -->
...
| Metric | Value |
|---|---|
| Learning docs scored | 80 |
| **Learning-debt (total HARD defects)** | **2** (2 in-doc + 0 coverage + 0 stamp) |
| Soft signals (judgment calls) | 148 |
| Mean score | 96.8/100 |
| Median / min / max | 97.0 / 88.6 / 100.0 |
...
|---:|---:|---:|:--:|:--:|:--:|:--|---|
| 0.792 | 51.2 | 95.4 | A | 1 | 2 | howto | `docs/fak/deployment-guide.md` |
| 0.756 | 70.0 | 92.0 | A | 0 | 4 | reference | `docs/fak/server-config.md` |
| 0.734 | 34.7 | 88.6 | B | 1 | 4 | howto | `docs/fak/mac-agent-ui.md` |
...
|---:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|---:|---|
| 88.6 | B | 1 | 67 | 100 | 88 | 100 | 75 | 100 | 100 | 34.7 | `docs/fak/mac-agent-ui.md` |
...
| 95.4 | A | 1 | 100 | 100 | 88 | 100 | 90 | 100 | 80 | 51.2 | `docs/fak/deployment-guide.md` |
...
| 96.2 | A | 0 | 90 | 100 | 88 | 100 | 100 | 100 | 100 | 48.8 | `docs/fak/api-reference.md` |
...
| 96.6 | A | 0 | 92 | 100 | 88 | 100 | 100 | 100 | 100 | 37.1 | `docs/fak/dojo-rsi-loop.md` |
...
| 97.0 | A | 0 | 100 | 100 | 88 | 100 | 90 | 100 | 100 | 32.4 | `docs/fak/lab-dev-loop.md` |
...
| 97.8 | A | 0 | 100 | 88 | 100 | 100 | 100 | 100 | 100 | 22.4 | `docs/fak/concept-glossary.md` |
...
| 98.2 | A | 0 | 100 | 100 | 88 | 100 | 100 | 100 | 100 | 51.2 | `docs/explainers/engineering-is-building-loops.md` |
...
| 98.2 | A | 0 | 100 | 90 | 100 | 100 | 100 | 100 | 100 | 51.2 | `docs/explainers/policy-in-the-kernel.md` |
...
| 98.8 | A | 0 | 100 | 100 | 100 | 100 | 90 | 100 | 100 | 30.0 | `docs/explainers/tool-call-is-a-syscall.md` |
...
| 100.0 | A | 0 | 100 | 100 | 100 | 100 | 100 | 100 | 100 | 62.4 | `LEARNING-PATH.md` |
...
### `docs/fak/deployment-guide.md` — 1 defect(s), score 95.4 (A)
- freshness: stale install pin 0.36.0 (VERSION is 0.37.0)

### `docs/fak/mac-agent-ui.md` — 1 defect(s), score 88.6 (B)
- orientation: no outbound link to another doc (a navigational dead-end in the curriculum)
