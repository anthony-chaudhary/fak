...
| `nativecodeworkspace` | off-by-default (wired) | `--native-code-workspace` | `NativeCodeWorkspace` | `internal/gateway/gateway.go:2031` | arms the bounded kernel coding-tool catalog under the declared workspace root; requires --native |
