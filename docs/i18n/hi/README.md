...
> इंस्टॉल का रास्ता देकर आगे [अंग्रेज़ी डॉक्स](https://github.com/anthony-chaudhary/fak/blob/main/README.md) तक पहुँचाता है।
...
```bash
fak manage claude      # आपके मौजूदा एजेंट को एक ही कमांड में wrap कर देता है
```
