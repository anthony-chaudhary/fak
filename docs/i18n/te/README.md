...
> install మార్గం ఇచ్చి, మిమ్మల్ని [ఇంగ్లీష్ డాక్స్](../../../README.md) వైపు
> తీసుకెళ్తుంది.
...
- [README (పూర్తి అవలోకనం)](../../../README.md)
- [START-HERE — 10 నిమిషాల్లో local model](../../../START-HERE.md)
- [Getting Started — binary install చేయండి](../../../GETTING-STARTED.md)
...
- [BENCHMARK-AUTHORITY — ప్రతి సంఖ్యకు మూలం](../../../BENCHMARK-AUTHORITY.md)
- [CLAIMS — ఏది shipped/simulated/stub](../../../CLAIMS.md)
