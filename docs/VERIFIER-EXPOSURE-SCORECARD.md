...
|---:|---|---|---:|:---:|
| 1 | `kpi-tests` | `deterministic` | 0.35 | true |
| 2 | `trajctl-judge` | `llm_judge` | 0.25 | false |
| 3 | `policy-smart-approval` | `deterministic` | 0.20 | false |
| 4 | `ship-integrity` | `deterministic` | 0.20 | false |
| 5 | `antipattern` | `deterministic` | 0.00 | false |
