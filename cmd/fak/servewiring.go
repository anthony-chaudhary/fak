...
var servewiringData = []wiringRow{
	...
	{"nativecodeworkspace", "--native-code-workspace", "NativeCodeWorkspace", verdictOffByDefault, "internal/gateway/gateway.go:2031", "arms the bounded kernel coding-tool catalog under the declared workspace root; requires --native"},
