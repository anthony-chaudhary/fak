...
var servewiringData = []wiringRow{
	...
	{"elideresult", "--elide-result-bytes", "ElideResultBytes", verdictOffByDefault, "internal/gateway/gateway.go:DefaultElideResultBytes", "oversized-result elision threshold; ships dark at gateway.DefaultElideResultBytes until deliberately armed"},
