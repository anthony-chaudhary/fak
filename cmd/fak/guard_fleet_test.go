...
// GATED WIP — test twin of guard_fleet.go: exercises the not-yet-committed gateway.SessionFleet
// surface, fenced behind //go:build wip_sessionfleet so the default build/test/vet stays green.
// Remove this line once gateway.SessionFleet lands (in lockstep with guard_fleet.go).
package main
