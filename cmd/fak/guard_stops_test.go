...
func TestGuardStopDispositionKind(t *testing.T) {
	cases := map[guardStopDisposition]guardStopKind{
		...
		stopDispOperatorQuestionResolved: stopKindContinue,
		stopDispOperatorQuestionBlocked:  stopKindContinue,
		stopDispOperatorQuestionEscalate: stopKindClean,
		...
		stopDispHandoffSessionGiveUp:     stopKindStandDown,
