...
var serveHelpCategories = []serveHelpCategory{
	...
	{name: "model", summary: "Local engines, weights, parallelism, and hardware.", flags: strings.Fields("engine backend gguf tokenizer qwen38-runtime llama-server llama-startup-timeout cuda-graph cpu-offload-experts n-cpu-moe gpu-layers native-gpu-layers gpudirect-overflow metal expert-parallel tensor-parallel replica-base-url vulkan-q4k-profile vulkan-stage-q4k")},
