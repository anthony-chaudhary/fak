...
var serveHelpCategories = []serveHelpCategory{
	...
	{name: "observe", summary: "Notifications, metrics, debug stats, and dojo mode.", flags: strings.Fields("notify-native notify-webhook notify-slack otlp-traces-endpoint debug-stats metrics-snapshot dojo keep-awake")},
