...
var serveHelpCategories = []serveHelpCategory{
	...
	{name: "model", summary: "Local engines, weights, parallelism, and hardware.", flags: strings.Fields("engine backend gguf tokenizer native-qwen-q4k-prefill-chunk-tokens qwen38-runtime llama-server llama-startup-timeout cuda-graph cpu-offload-experts n-cpu-moe metal expert-parallel tensor-parallel replica-base-url")},
	...
	{name: "native", summary: "Owned agent loop, coding tools, and speculation.", flags: strings.Fields("native native-max-turns native-admission-token-budget native-code-tools native-code-workspace native-speculate vdso-proxy-fill")},
