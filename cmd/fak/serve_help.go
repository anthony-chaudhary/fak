...
var serveHelpCategories = []serveHelpCategory{
	{name: "start", summary: "Listener, deployment manifest, and provider connection.", flags: strings.Fields("addr stdio config print-effective-config provider base-url model opencode opencode-config write-opencode-config api-key-env require-key-env allow-lan stream-progress-timeout expose key-principal unsafe-allow-unauthenticated-bind")},
