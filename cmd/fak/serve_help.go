...
var serveHelpCategories = []serveHelpCategory{
	...
	{name: "context", summary: "Context budgets, compaction, elision, and reuse.", flags: strings.Fields("ctx-view-budget compact-history-budget positive-residual-substitution compact-anchor-head assume-session-turns elide-result-bytes elide-stale-reads vcache-anchor defer-cold-tools defer-tools tool-ceiling context-budget-tokens reset-on-budget")},
