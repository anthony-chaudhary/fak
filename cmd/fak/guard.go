...
func cmdManageCommand(commandName string, argv []string) {
	...
	speculativeMode := fs.String("speculative", "mtp", "structural speculative-decode selector for the in-kernel --gguf path (#1891): mtp (default) or ngram; empty disables; FAK_SPECULATIVE/SPECULATIVE env overrides")
