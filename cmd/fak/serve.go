...
func newServeFlagSet() (*flag.FlagSet, *serveFlags) {
	...
	sf.nativeQwenQ4KPrefillChunk = fs.Int(serveNativeQwenQ4KPrefillChunkFlag, defaultNativeQwenQ4KPrefillChunk, "fak-native resident Qwen Q4_K prefill chunk ceiling in tokens (128..4096; default 512); validated before model load and stamped into native inference receipts; never selects or falls back to llama.cpp")
