...
func rawDecodePhysicalReceipt(execution rawdecode.Execution, _ ...[]rawRepOutput) rawDecodePhysicalReceiptAttempt {
	...
	// Timing fields below remain exported diagnostic observations. The generation
	// seal authenticates only policy and accepted token IDs; #12096 owns physical
	// timing authority and this incomplete leaf remains non-creditable.
