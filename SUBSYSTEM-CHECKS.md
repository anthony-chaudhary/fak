...
<!-- GPU server / endpoint-load artifact-integrity check excluded from the public copy (operator-private lab infra); its private-side tool targets stay out of public evidence. -->
