...
```sh
fak version          # prints the installed version, e.g. 0.47.0
```
...
| --- | --- | --- |
| `FAK_VERSION` | Pin a version, e.g. `0.47.0` | latest release |
...
```sh
FAK_VERSION=0.47.0 FAK_INSTALL_DIR="$HOME/.local/bin" \
