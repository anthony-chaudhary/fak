...
```sh
fak version          # prints the installed version, e.g. 0.54.0
```
...
| --- | --- | --- |
| `FAK_VERSION` | Pin a version, e.g. `0.54.0` | latest release |
...
```sh
docker build --build-arg APP_VERSION=0.54.0 -t fak:0.54.0 .
```
