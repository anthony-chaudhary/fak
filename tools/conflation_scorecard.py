...
def markdown(payload: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        'description: "fak\'s deterministic conflation scorecard: does every number and '
        'status fak reports label its provenance - WITNESSED (a fact fak authored) vs '
        'OBSERVED (a value relayed from an external party) - folded into a conflation-debt count."',
        "---",
        "",
