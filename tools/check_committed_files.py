...
Rules:
  ...
  * SCRIPT admission — random shell and PowerShell scripts (*.ps1, *.sh, *.bat,
    *.cmd) — ALWAYS refused unless grandfathered. Prefer making Go sub-modules
    (nested modules under tools/<name>/) or Go applications (cmd/ or internal/
    leaves) rather than shell/PowerShell scripts.
...
DISALLOWED_SCRIPT_EXTS = (".ps1", ".sh", ".bat", ".cmd", ".bash", ".zsh")

SCRIPT_REFUSAL_REASON = (
    "random shell/powershell script (.ps1/.sh/.bat/.cmd) refused: prefer making "
    "Go sub-modules (nested modules under tools/<name>/), Go applications (cmd/), "
    "or Go leaves (internal/) rather than shell or PowerShell scripts "
    "(AGENTS.md: prefer Go tooling/submodules). Port automation to Go."
)

GRANDFATHERED_SCRIPTS = frozenset({
    ".github/scripts/native-performance-regression.sh",
    ".github/scripts/native-performance-regression_test.sh",
    ".github/scripts/trajectory-attribution-nightly.sh",
    ".github/scripts/verify-release-checksums.sh",
    ".github/scripts/verify-release-checksums_test.sh",
    ...
    "docs/_witnesses/issue-9172-hardware-net-token-value/calculate.ps1",
    "docs/_witnesses/issue-9827-amd-vllm-sglang/run-mi300x-baselines.sh",
    "docs/benchmarks/harness-creation/baselines/create-mastra-1.25.0/run.ps1",
    "docs/benchmarks/harness-creation/receipts/linux-clean-shape-calibration-4/run.sh",
    "docs/benchmarks/harness-creation/receipts/windows-clean-mastra-calibration-1/run.ps1",
    "docs/benchmarks/prompt-vault/verify-color-palette.ps1",
    "examples/addressable-evict/run.sh",
    "examples/adjudication-demo/run.sh",
    "examples/admit-and-log/run.sh",
    "examples/affectedtests-comparison/run.ps1",
    "examples/agent-ab/run.sh",
    "examples/agentdojo-redteam/run.sh",
    "examples/auth-hardening/run.sh",
    "examples/bench-latency/run.sh",
    "examples/commit-audit-in-60s/run.sh",
    "examples/component-contracts/run.ps1",
    "examples/compose-ollama/run.sh",
    "examples/context-debugger/run.sh",
    "examples/corporate-tls/run.sh",
    "examples/corporate-tls/selfcheck.sh",
    "examples/deny-as-value/run.sh",
    "examples/deny-in-60s/run.sh",
    "examples/dogfood-claude/run.ps1",
    "examples/dogfood-claude/run.sh",
    "examples/escalation-demo/run.sh",
    "examples/fanbench/run.sh",
    "examples/federated-changes/run.sh",
    "examples/fleet-reuse-demo/run.sh",
    "examples/gpu-smoke/run-cuda.sh",
    "examples/gpu-smoke/run-vulkan.sh",
    "examples/grammar-repair/run.sh",
    "examples/ifc-taint-flow/run.sh",
    "examples/loader-properties/run.sh",
    "examples/mcp-client/run.sh",
    "examples/normgate-evasion/run.sh",
    "examples/observability/run.sh",
    "examples/plan-cfi/run.sh",
    "examples/playground/play.sh",
    "examples/policy-hot-reload/run.sh",
    "examples/policy-loader-properties/run.sh",
    "examples/preflight-ladder/run.sh",
    "examples/quarantine-demo/run.sh",
    "examples/radixattention/run.sh",
    "examples/remote-vm-guard/run.sh",
    "examples/self-modify-floor/run.sh",
    "examples/session-reload/run.sh",
    "examples/shared-task-record/run.sh",
    "examples/shared-task-record-verdicts/run.sh",
    "examples/skill-program/run.ps1",
    "examples/steward-demo/run.sh",
    "examples/trace-authoring/run.sh",
    "examples/trace-reset/run.sh",
    "examples/turntax/run.sh",
    "examples/vdso-cache-hit/run.sh",
    "examples/verified-memory-recall/run.sh",
    "examples/vm-fs-guard/run.sh",
    "examples/wire-quarantine-demo/run.sh",
    "examples/witness-gate/run.sh",
    "experiments/qwen36/witness-cpu-decode.sh",
    "experiments/vllm/glm52-agentic-battery/run.sh",
    "install.sh",
    "internal/compute/build_cuda.sh",
    "internal/compute/build_vulkan.ps1",
    "internal/compute/setup_cuda_wsl.sh",
    "internal/fleetaccounts/testdata/parity_check.sh",
    "internal/model/bench_scaling.sh",
    "macos/LocalAppHelper/scripts/package-helper.sh",
    "scripts/build.sh",
    "scripts/ci.ps1",
    "scripts/claims-lint.ps1",
    "scripts/claude-kimi-k3.ps1",
    "scripts/claude-kimi-k3.sh",
    "scripts/claude-nim-deepseek.ps1",
    "scripts/claude-nim-deepseek.sh",
    "scripts/claude-nim-kimi.ps1",
    "scripts/claude-nim-kimi.sh",
    "scripts/connect-fak-node.ps1",
    "scripts/connect-fak-node.sh",
    "scripts/dgx-deepseek-serve.sh",
    "scripts/dgx-kimi-serve.sh",
    "scripts/dogfood-claude.ps1",
    "scripts/dogfood-claude.sh",
    "scripts/dogfood-claude_test.sh",
    "scripts/dogfood-opencode-glm.sh",
    "scripts/fetch-gguf.ps1",
    "scripts/fetch-gguf.sh",
    "scripts/fetch-gguf_test.sh",
    "scripts/fetch-model.ps1",
    "scripts/fetch-model.sh",
    "scripts/fetch-model_test.sh",
    "scripts/gcp-dogfood-control-vm.sh",
    "scripts/gcp-fleet-janitor.sh",
    "scripts/gcp-glm-demo.sh",
    "scripts/gcp-glm-serve.sh",
    "scripts/gcp-idle-reaper-install.sh",
    "scripts/gcp-idle-reaper.sh",
    "scripts/gcp-qwen-serve.sh",
    "scripts/gcp-realmodel-note.sh",
    "scripts/gcp-startup-timeouts_test.sh",
    "scripts/gofmt-check.sh",
    "scripts/local-qwen38-metal-observe.sh",
    "scripts/local-qwen38-metal-observe_test.sh",
    "scripts/logvault-restore-drill.sh",
    "scripts/overnight-check.sh",
    "scripts/overnight-loop.sh",
    "scripts/schedule-top20-performance.sh",
    "scripts/test-fast-build-fixture.sh",
    "scripts/test-fast-build_test.sh",
    "test.ps1",
    "test.sh",
    "tools/_run_realistic_workload.sh",
    "tools/bench_node.sh",
    "tools/bench_node_resolve_test.sh",
    "tools/bench_plan_tick.ps1",
    "tools/build_cuda_windows.ps1",
    "tools/build_prebuilt_node_payload.sh",
    "tools/capture_fleet_task_xml.ps1",
    "tools/cuda_acceptance.sh",
    "tools/deepseek2_fak_native_serve.sh",
    "tools/deepseekv4_stage_serve_gpu_server.sh",
    "tools/dgx_decode_occupancy_ncu.sh",
    "tools/dgx_fak_gateway_repolicy.sh",
    "tools/dgx_glm_gpu_witness.sh",
    "tools/dgx_glm_throughput_run.sh",
    "tools/dgx_pure_kernel_bench.sh",
    "tools/dgx_pure_kernel_run.sh",
    "tools/dgx_swebench_launch.sh",
    "tools/dgx_witness_run.sh",
    "tools/eraser_sweep.sh",
    "tools/fak-serve-caffeinate.sh",
    "tools/fak_laptop_test.ps1",
    "tools/fak_loop_run.sh",
    "tools/fak_loop_task.ps1",
    "tools/fak_node_bench.sh",
    "tools/fak_stall_monitor.ps1",
    "tools/fleet_dos_dispatch_watchdog.ps1",
    "tools/fleet_endpoints.ps1",
    "tools/fleet_endpoints.sh",
    "tools/fleet_resume_watchdog.ps1",
    "tools/fleet_status.ps1",
    "tools/fleet_supervisor_watchdog.ps1",
    "tools/fleet_sweep_run.sh",
    "tools/fleet_target.ps1",
    "tools/fleet_target_test.ps1",
    "tools/fleet_write_scan.sh",
    "tools/forge-rulesets/apply.sh",
    "tools/glm52_bench_lever.sh",
    "tools/glm52_e2e_after_serve_gpu_server.sh",
    "tools/glm52_ep_preflight_selfcheck.sh",
    "tools/glm52_ep_witness.sh",
    "tools/glm52_fak_native_serve.sh",
    "tools/glm52_l1_rowsplit_ab.sh",
    "tools/glm52_l4_fa_cudagraph_ab.sh",
    "tools/glm52_load_witness.sh",
    "tools/glm52_mgpu_serve.sh",
    "tools/glm52_serve.sh",
    "tools/glm52_sglang_vllm_serve.sh",
    "tools/glm52_stage_serve_gpu_server.sh",
    "tools/grafana/down.sh",
    "tools/grafana/up.sh",
    "tools/host_stall_mitigations.ps1",
    "tools/install-mac-node.sh",
    "tools/install_self_update_schedule.ps1",
    "tools/laptop_dispatch_config.ps1",
    "tools/laptop_watchdog_setup.ps1",
    "tools/launch_goal_detached.ps1",
    "tools/launch_wave_detached.ps1",
    "tools/livecodebench_smoke_gpu_server.sh",
    "tools/mac_keep_awake.sh",
    "tools/migrate_fleet_tasks_to_s4u.ps1",
    "tools/migrate_fleet_tasks_to_s4u_test.ps1",
    "tools/notify.ps1",
    "tools/ornith_fak_serve.sh",
    "tools/popularization_dispatch_loop.sh",
    "tools/qwen36_a100_fak_serve.sh",
    "tools/qwen36_mac_parity_gate.sh",
    "tools/race_test.sh",
    "tools/reboot_advisor.ps1",
    "tools/register_bench_plan_doc.ps1",
    "tools/register_control_pane_tick.ps1",
    "tools/register_control_pane_tick.sh",
    "tools/register_dispatch_log_audit.ps1",
    "tools/register_dispatch_session_audit.ps1",
    "tools/register_dispatch_status_doc.ps1",
    "tools/register_dos_dispatch_watchdog.ps1",
    "tools/register_dos_dispatch_watchdog.sh",
    "tools/register_fleet_slack_status.ps1",
    "tools/register_grafana_rollup.ps1",
    "tools/register_idea_scout.ps1",
    "tools/register_issue_dispatch.ps1",
    "tools/register_learning_docs_freshness.ps1",
    "tools/register_logvault_backup.ps1",
    "tools/register_loops_inventory.ps1",
    "tools/register_mac_watchers.sh",
    "tools/register_proc_resource_guard.ps1",
    "tools/register_push_lag_pusher.ps1",
    "tools/register_reboot_advisor.ps1",
    "tools/register_resolve_progress.ps1",
    "tools/register_resume_watchdog.ps1",
    "tools/register_runaway_reaper.ps1",
    "tools/register_scout_loop.ps1",
    "tools/register_session0_sweep.ps1",
    "tools/register_session_checkpoint.ps1",
    "tools/register_slack_beat.ps1",
    "tools/register_stale_work_watchdog.ps1",
    "tools/register_supervisor_watchdog.ps1",
    "tools/register_worktree_doctor.ps1",
    "tools/relogin_seat.ps1",
    "tools/run_476_acceptance_on_arm64.sh",
    "tools/run_477_acceptance_on_arm64.sh",
    "tools/run_478_acceptance_on_arm64.sh",
    ...
    "tools/run_comparison_demos.sh",
    "tools/run_local_model.sh",
    "tools/run_overnight_soak.ps1",
    "tools/run_phase1_gate.sh",
    "tools/run_prebuilt_node_bench.sh",
    "tools/run_prebuilt_turn_agent_sweep.sh",
    "tools/run_remote_model.sh",
    "tools/run_transcript_adapter_sweep.ps1",
    "tools/run_turn_state_demos.sh",
    "tools/runaway_process_reaper.ps1",
    "tools/runaway_process_scan.ps1",
    "tools/scheduled-tasks/fak-bench-fleet-tick.cmd",
    "tools/send_prebuilt_node_payload.ps1",
    "tools/serialize_goal_fleet.ps1",
    "tools/watchdog_watchdog_audit.ps1",
    "visuals/refresh-stale.sh",
    "visuals/render-hero-pngs.sh",
    "visuals/render.sh",
})
...
def _is_script_file(path: str) -> bool:
    low = path.lower()
    return any(low.endswith(ext) for ext in DISALLOWED_SCRIPT_EXTS)


def _script_admission_reason(path: str) -> str | None:
    if not _is_script_file(path):
        return None
    if path in GRANDFATHERED_SCRIPTS:
        return None
    return SCRIPT_REFUSAL_REASON
...
def _classify(path, root, max_bytes):
    ...
    for rx, why in PRIVATE_ONLY:
        if rx.search(path):
            return why
    why_script = _script_admission_reason(path)
    if why_script:
        return why_script
