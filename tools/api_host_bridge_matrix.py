...
WITNESSES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "required": False,
        "command": "fak api-host readiness --out fak/experiments/api-host-bridge/api-host-readiness.json --markdown fak/experiments/api-host-bridge/api-host-readiness.md",
        "checks": [
            {"type": "file_exists", "path": "cmd/fak/api_host.go"},
            {"type": "file_exists", "path": "internal/apihostprobe/apihostprobe.go"},
            {"type": "file_exists", "path": "internal/apihostprobe/apihostprobe_test.go"},
