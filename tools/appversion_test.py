#!/usr/bin/env python3
"""Tests for the shared fleet version helpers (tools/appversion.py).
...
Run: `python tools/appversion_test.py`  (exit 0 = all pass),
or `python -m pytest tools/appversion_test.py -q`.
"""
...
import appversion as fv  # noqa: E402
