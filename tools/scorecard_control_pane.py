...
SCORECARDS: list[dict[str, str]] = [
    ...
    {"key": "brittleness", "debt": "brittleness_debt", "script": "", "cmd": "go run ./cmd/fak score brittleness --json", "label": "brittleness"},
    ...
    {"key": "conflation", "debt": "conflation_debt", "script": "", "cmd": "go run ./cmd/fak score conflation --json", "label": "conflation"},
    ...
    {"key": "ui_quality", "debt": "ui_quality_debt", "script": "", "cmd": "go run ./cmd/fak score ui-quality --json", "label": "ui-quality"},
...
# Unfolded Go-backed scorecards documented and tracked outside the default portfolio fold:
# - performance-rsi-scorecard (internal/perfrsiscore, performance_rsi_debt): requires versioned evidence input
# - unwired-scorecard (internal/unwiredscore, unwired_debt): repository audit verb
# - checkpoint-scorecard (internal/checkpointscore, checkpoint_debt): model checkpoint validation
# - mlp-score (internal/mlpscore, mlp_debt): MLP weight scorecard
# - skill-effectiveness-scorecard (internal/skilleffectiveness, skill_debt): per-skill analysis
...
SCOREBOARD_DEBT_DOC_REL = "docs/scoreboard-debt.md"


DEBT_CATEGORIES_METADATA: list[dict[str, Any]] = [
    {
        "key": "doc",
        "label": "docs",
        "debt_key": "doc_debt",
        ...
        "doc_link": "`tools/docs_scorecard.py`",
    ...
    },
    {
        ...
        "doc_link": "[docs/CODE-QUALITY-SCORECARD.md](CODE-QUALITY-SCORECARD.md)",
    ...
    },
    {
        ...
        "default_grad": 1,
        "tool": "fak score seo",
        "doc_link": "[docs/index.md](index.md)",
        "cluster": "Documentation, freshness, and discoverability",
    ...
    },
    {
        ...
        "doc_link": "[docs/DEMO-QUALITY-SCORECARD.md](DEMO-QUALITY-SCORECARD.md)",
    ...
    },
    {
        "key": "hygiene",
        "label": "repo-hygiene",
        "debt_key": "hygiene_debt",
        "unit": "Duplicate dirs, misplaced notes, orphan pages",
        "default_pin": 22,
        "default_grad": 2,
        "tool": "tools/repo_hygiene_scorecard.py",
        "doc_link": "[docs/REPO-HYGIENE-SCORECARD.md](REPO-HYGIENE-SCORECARD.md)",
        "cluster": "Documentation, freshness, and discoverability",
    ...
    },
    {
        ...
        "doc_link": "[docs/sota/](sota/README.md)",
        "cluster": "Kernel architecture and compute SOTA",
    ...
    },
    {
        ...
        "debt_key": "friction_debt",
        "unit": "Friction preventing agents discovering/adopting fak",
        "default_pin": 12,
        "default_grad": 0,
        "tool": "fak score agent-readiness",
        "doc_link": "[docs/AGENT-READINESS-SCORECARD.md](AGENT-READINESS-SCORECARD.md)",
    ...
    },
    {
        ...
        "debt_key": "popularization_debt",
        "unit": "Leaks across 5-stage conversion funnel",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "tools/popularization_readiness_scorecard.py",
        "doc_link": "[docs/popularization-scorecard/](popularization-scorecard/README.md)",
        "cluster": "Product, persona, and adoption funnel",
    ...
    },
    {
        ...
        "doc_link": "`tools/code_slop_scorecard.py`",
        "cluster": "Code quality and maintenance",
    ...
    },
    {
        "key": "conflation",
        "label": "conflation",
        "debt_key": "conflation_debt",
        "unit": "Reporting provider-observed values as fak-witnessed",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak score conflation",
        "doc_link": "[docs/CONFLATION-SCORECARD.md](CONFLATION-SCORECARD.md)",
    ...
    },
    {
        "key": "ui_quality",
        "label": "ui-quality",
        "debt_key": "ui_quality_debt",
        "unit": "Multibyte rune slicing, column shear, missing help",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak score ui-quality",
        "doc_link": "[docs/UI-QUALITY-SCORECARD.md](UI-QUALITY-SCORECARD.md)",
        "cluster": "Delivery flow, commits, and operations",
    ...
    },
    {
        ...
        "debt_key": "disambiguation_debt",
        "unit": "Overloaded symbol roots, terminology collisions",
        "default_pin": 5,
        "default_grad": 0,
        "tool": "tools/concept_disambiguation_scorecard.py",
        "doc_link": "[docs/concept-disambiguation-scorecard/](concept-disambiguation-scorecard/README.md)",
        "cluster": "Concept clarity and truth maintenance",
    ...
    },
    {
        ...
        "debt_key": "intent_literal_debt",
        "unit": "Divergence between test intent assertions and reality",
        "default_pin": 6,
        "default_grad": 2,
        "tool": "tools/intent_literal_scorecard.py",
        "doc_link": "[docs/intent-literal-scorecard/](intent-literal-scorecard/README.md)",
        "cluster": "Concept clarity and truth maintenance",
    ...
    },
    {
        ...
        "debt_key": "token_defaults_debt",
        "unit": "High-value token savers disabled by default",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak score token-defaults",
        "doc_link": "[docs/serving/token-defaults-scorecard.md](serving/token-defaults-scorecard.md)",
        "cluster": "Governance, safety, and guard systems",
    ...
    },
    {
        "key": "dogfood",
        "label": "dogfood-loop",
        "debt_key": "dogfood_debt",
        "unit": "Omission of real binary/model execution in loop tests",
        "default_pin": 1,
        "default_grad": 1,
        "tool": "fak score dogfood",
        "doc_link": "[docs/fak/dogfood-loop-scorecard.md](fak/dogfood-loop-scorecard.md)",
        "cluster": "Delivery flow, commits, and operations",
    ...
    },
    {
        "key": "conceptusage",
        "label": "concept-usage",
        "debt_key": "conceptusage_debt",
        "unit": "Internal development bypassing fak's own concepts",
        "default_pin": 3,
        "default_grad": 8,
        "tool": "fak score concept-usage",
        "doc_link": "[docs/fak/concept-usage-scorecard.md](fak/concept-usage-scorecard.md)",
        "cluster": "Concept clarity and truth maintenance",
    ...
    },
    {
        "key": "lightgap",
        "label": "lightgap",
        "debt_key": "lightgap_debt",
        "unit": "Usability gaps vs next-best operator alternatives",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak score lightgap",
        "doc_link": "[docs/lightgap-scorecard/](lightgap-scorecard/README.md)",
        "cluster": "Product, persona, and adoption funnel",
    ...
    },
    {
        ...
        "debt_key": "support_maturity_debt",
        "unit": "Model architecture x accelerator backend gaps",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak score support-maturity",
        "doc_link": "[docs/HARDWARE-MATRIX.md](HARDWARE-MATRIX.md)",
        "cluster": "Kernel architecture and compute SOTA",
    ...
    },
    {
        "key": "milestone",
        "label": "milestone",
        "debt_key": "milestone_debt",
        "unit": "Distance to MATURED rungs across support grid",
        "default_pin": 72,
        "default_grad": 2,
        "tool": "fak score milestone",
        "doc_link": "[docs/milestones/STATUS.md](milestones/STATUS.md)",
        "cluster": "Lifecycle, milestones, and release velocity",
    ...
    },
    {
        "key": "loopindex",
        "label": "loop-index",
        "debt_key": "loopindex_debt",
        "unit": "Broken stages in 6-stage autonomous coding loop",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak score loop-index",
        "doc_link": "[docs/fak/loop-scorecard.md](fak/loop-scorecard.md)",
        "cluster": "Lifecycle, milestones, and release velocity",
    ...
    },
    {
        "key": "claim_repro",
        "label": "claim-repro",
        "debt_key": "claim_repro_debt",
        "unit": "Unresolvable/unfalsifiable witness claims",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "tools/claim_repro_scorecard.py",
        "doc_link": "[docs/CLAIM-REPRO-SCORECARD.md](CLAIM-REPRO-SCORECARD.md)",
        "cluster": "Delivery flow, commits, and operations",
    ...
    },
    {
        ...
        "debt_key": "release_debt",
        "unit": "Manual friction in cutting, signing, or rolling back",
        "default_pin": 2,
        "default_grad": 1,
        "tool": "tools/release_readiness_scorecard.py",
        "doc_link": "[docs/RELEASE-READINESS-SCORECARD.md](RELEASE-READINESS-SCORECARD.md)",
        "cluster": "Lifecycle, milestones, and release velocity",
    ...
    },
    {
        "key": "observability",
        "label": "observability",
        "debt_key": "observability_debt",
        "unit": "Dashboards/alerts referencing non-existent metrics",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "tools/observability_scorecard.py",
        "doc_link": "[docs/OBSERVABILITY-SCORECARD.md](OBSERVABILITY-SCORECARD.md)",
        "cluster": "Delivery flow, commits, and operations",
    ...
    },
    {
        ...
        "doc_link": "`tools/rsi_maturity_scorecard.py`",
        "cluster": "Delivery flow, commits, and operations",
    ...
    },
    {
        ...
        "doc_link": "`tools/tooling_quality_scorecard.py`",
        "cluster": "Code quality and maintenance",
    ...
    },
    {
        "key": "persona_fit",
        "label": "persona-fit",
        "debt_key": "persona_fit_debt",
        "unit": "Persona matrix grounding gaps for enterprise users",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "tools/persona_fit_scorecard.py",
        "doc_link": "[docs/persona-fit-scorecard/](persona-fit-scorecard/README.md)",
        "cluster": "Product, persona, and adoption funnel",
    ...
    },
    {
        "key": "osp_residual",
        "label": "osp-residual",
        "debt_key": "residual_count",
        "unit": "Forming PR units awaiting operator review",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak steer prs",
        "doc_link": "[docs/operator-steerability-prs.md](operator-steerability-prs.md)",
        "cluster": "Delivery flow, commits, and operations",
    ...
    },
    {
        "key": "antipattern",
        "label": "antipattern",
        "debt_key": "antipattern_debt",
        "unit": "Detected anti-patterns across agent sessions",
        "default_pin": 0,
        "default_grad": 0,
        "tool": "fak antipattern-scorecard",
        "doc_link": "[docs/notes/AGENTIC-DEV-ANTIPATTERNS-2026-07-02.md](notes/AGENTIC-DEV-ANTIPATTERNS-2026-07-02.md)",
        "cluster": "Code quality and maintenance",
...
def generate_scoreboard_debt_doc(baseline: dict[str, Any] | None = None) -> str:
    metrics_map = (baseline or {}).get("metrics") or {}
    weights_map = (baseline or {}).get("grade_weights") or {}
    ...
    lines = [
        ...
        "",
        f"The portfolio tracks {len(DEBT_CATEGORIES_METADATA)} distinct debt categories across code quality, documentation, concepts, adoption, kernel compute, governance, and operational flow:",
        "",
        "| Metric | Debt Key | Defect Unit / Unbounded Driver | Baseline Pin | Severity Weight | Owning Command / Tool | Reference Doc |",
        "|---|---|---|---|---|---|---|",
    ]

    for cat in DEBT_CATEGORIES_METADATA:
        pin = metrics_map.get(cat["key"], cat["default_pin"])
        grad = weights_map.get(cat["key"], cat["default_grad"])
        letter = _weight_letter(grad)
        lines.append(
            f"| `{cat['label']}` | `{cat['debt_key']}` | {cat['unit']} | {pin} | {grad} ({letter}) | `{cat['tool']}` | {cat['doc_link']} |"
        )
...
def write_scoreboard_debt_doc(root: Path, baseline_path: Path) -> bool:
    baseline = load_baseline(baseline_path)
    content = generate_scoreboard_debt_doc(baseline)
    doc_path = root / SCOREBOARD_DEBT_DOC_REL
    if doc_path.exists() and doc_path.read_text(encoding="utf-8").replace("\r\n", "\n") == content.replace("\r\n", "\n"):
        return False
...
def check_scoreboard_debt_doc(root: Path, baseline_path: Path) -> tuple[bool, str]:
    baseline = load_baseline(baseline_path)
    doc_path = root / SCOREBOARD_DEBT_DOC_REL
    if not doc_path.exists():
        return False, f"STALE  {SCOREBOARD_DEBT_DOC_REL}: not found; run python tools/scorecard_control_pane.py --write-doc"
    actual = doc_path.read_text(encoding="utf-8").replace("\r\n", "\n")
    expected = generate_scoreboard_debt_doc(baseline).replace("\r\n", "\n")
    if actual != expected:
        return False, f"STALE  {SCOREBOARD_DEBT_DOC_REL}: drifted from baseline; run python tools/scorecard_control_pane.py --write-doc"
    return True, f"OK  {SCOREBOARD_DEBT_DOC_REL}: fresh ({len(DEBT_CATEGORIES_METADATA)} debt categories verified)"
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--write-doc", action="store_true",
                    help=f"regenerate {SCOREBOARD_DEBT_DOC_REL} in place")
    ap.add_argument("--check-doc", action="store_true",
                    help=f"CI gate: red when {SCOREBOARD_DEBT_DOC_REL} is stale vs baseline")
    ap.add_argument("--markdown-doc", action="store_true",
                    help=f"emit the {SCOREBOARD_DEBT_DOC_REL} body to stdout")
    ...
    if args.markdown_doc:
        baseline = load_baseline(baseline_path)
        print(generate_scoreboard_debt_doc(baseline))
        return 0

    if args.write_doc:
        changed = write_scoreboard_debt_doc(root, baseline_path)
        if changed:
            print(f"wrote {SCOREBOARD_DEBT_DOC_REL}")
        else:
            print(f"{SCOREBOARD_DEBT_DOC_REL} already fresh; no change")
        return 0

    if args.check_doc:
        ok, msg = check_scoreboard_debt_doc(root, baseline_path)
        print(msg)
