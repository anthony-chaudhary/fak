...
WITNESSES: tuple[Witness, ...] = (
    ...
    Witness("timewolfdemo-print", ("go", "run", "./cmd/timewolfdemo", "-print"), ("DINNER TIME", "5 allowed")),
    Witness(
        "timewolfdemo-print-redteam",
        ("go", "run", "./cmd/timewolfdemo", "-print", "-scenario", "redteam"),
        ("POLICY_BLOCK", "DEFAULT_DENY", "1 allowed"),
        must_not_contain=("wiped",),
    ),
    Witness("timewolfdemo-json", ("go", "run", "./cmd/timewolfdemo", "-json"), ('"scenario": "mr-wolf"', "DINNER TIME")),
    Witness("timewolfdemo-selfcheck", ("go", "run", "./cmd/timewolfdemo", "-selfcheck"), ("all scenarios hold the agentic-floor invariants",)),
