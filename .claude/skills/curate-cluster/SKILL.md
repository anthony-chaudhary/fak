---
name: curate-cluster
description: Reconcile a research or documentation cluster's index with files on disk, repair dangling references, refresh counts and context, and ignore regenerable artifacts. Commit only quiescent documentation, experiment, tool, and index paths; exclude trees peers are actively changing. Use after a documentation burst, when an index drifts, or on a recurring gardening cadence.
---
