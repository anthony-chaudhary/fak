# Project guidelines — fak (JetBrains Junie)

> JetBrains' Junie auto-loads `.junie/guidelines.md` as project context. The canonical,
> fuller agent instructions are in [`AGENTS.md`](../AGENTS.md) — read it first for
> build/test/run, the repo map, and the rules. Doc map: [`llms.txt`](../llms.txt).
...
To run a model behind the kernel from a JetBrains IDE, follow
[`docs/integrations/jetbrains.md`](../docs/integrations/jetbrains.md).
