...
description: Plan, partition, and coordinate sustained multi-wave parallel subagent campaigns to retire large volumes of maturity debt across the repository. Uses `fak debt-lanes --plan-waves` to partition WIP into pairwise...
metadata:
...
Load and follow [`../../../.claude/skills/debt-orchestrator/SKILL.md`](../../../.claude/skills/debt-orchestrator/SKILL.md). This generated discovery adapter contains no maintained workflow body.
