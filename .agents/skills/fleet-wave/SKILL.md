---
name: fleet-wave
description: Generated Codex adapter for the canonical fak project skill fleet-wave.
metadata:
...
Load and follow [`../../../.claude/skills/fleet-wave/SKILL.md`](../../../.claude/skills/fleet-wave/SKILL.md). This generated discovery adapter contains no maintained workflow body.
