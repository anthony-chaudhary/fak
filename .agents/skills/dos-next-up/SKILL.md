---
name: dos-next-up
description: Generated Codex adapter for the canonical fak project skill dos-next-up.
metadata:
...
Load and follow [`../../../.claude/skills/dos-next-up/SKILL.md`](../../../.claude/skills/dos-next-up/SKILL.md). This generated discovery adapter contains no maintained workflow body.
